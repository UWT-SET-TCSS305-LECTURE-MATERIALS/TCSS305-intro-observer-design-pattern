...
package edu.uw.tcss.color.contoller;

import static edu.uw.tcss.color.model.PropertyChangeEnabledMutableColor.PROPERTY_COLOR;
import static edu.uw.tcss.color.model.PropertyChangeEnabledMutableColor.PROPERTY_BLUE;
import static edu.uw.tcss.color.model.PropertyChangeEnabledMutableColor.PROPERTY_GREEN;

import edu.uw.tcss.color.contoller.panels.BlueRowPanel;
import edu.uw.tcss.color.contoller.panels.GreenRowPanel;
import edu.uw.tcss.color.contoller.panels.RedRowPanel;
import edu.uw.tcss.color.contoller.panels.RowPanel;
import edu.uw.tcss.color.model.ColorModel;
import edu.uw.tcss.color.model.PropertyChangeEnabledMutableColor;
import edu.uw.tcss.color.view.ColorPanel;
...
//      The following demonstrates the generic RowPanel
//
//        add(new RowPanel(myColor,
//            "Green: ",
//            myColor::setGreen,
//            myColor::adjustGreen,
//            myColor::getGreen,
//            () -> new Color(0, myColor.getGreen(), 0),
//            PROPERTY_GREEN::equals));
//        add(new RowPanel(myColor,
//            "Blue: ",
//            theValue -> myColor.setBlue(theValue),
//            theValue -> myColor.adjustBlue(theValue),
//            () -> myColor.getBlue(),
//            () -> new Color(0, 0, myColor.getBlue()),
//            theOther -> PROPERTY_BLUE.equals(theOther)));
    ...
    public static void createAndShowGUI() {
        ...
        color.addPropertyChangeListener(PROPERTY_COLOR, cop);
