package edu.uw.tcss.time.v1.view;

import static edu.uw.tcss.time.v1.model.PropertyChangeEnabledTimeControls.PROPERTY_TIME;
...
public class TimePanel extends JPanel implements PropertyChangeListener {
    ...
    /** Padding for the border around the label. */
    private static final Dimension MARGIN = new Dimension(200, 75);
    ...
    public void propertyChange(final PropertyChangeEvent theEvent) {
        if (PROPERTY_TIME.equals(theEvent.getPropertyName())) {
            myLabel.setText(formatTime((int) theEvent.getNewValue()));
        }
